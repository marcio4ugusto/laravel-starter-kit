  ...
  return (
    <>
        ...
        <div className='flex flex-col items-center w-full pt-56'>
            ...
            <p className='mt-3 text-gray-500'>This Laravel starter kit brings <a href="https://github.com/tighten/ziggy">Ziggy</a>, <a href="https://inertiajs.com/">Inertia</a>, <a href="https://tailwindcss.com/">Tailwind CSS</a> and <a href='https://ui.shadcn.com/'>Shadcn/UI</a></p>
        </div>
